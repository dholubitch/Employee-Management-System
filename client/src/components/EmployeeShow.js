    ...
    <div className="container mx-auto mt-4 dark:bg-gray-700 dark:text-gray-400">
      ...
      <div className="md:flex md:items-end my-3"> 
        <div className="md:w-1/2 ">
          <div className="relative rounded-md shadow-sm  ">
            ...
            />
            <div className="absolute inset-y-0 right-0 p-3 flex items-center pointer-events-none d:bg-gray-700 dark:text-gray-400">
              <BiSearch className="h-5 w-5 text-gray-400" />
            </div>
          </div>
        </div>
        <div className=" md:w-1/2  dark:bg-gray-700 dark:text-gray-400">
          <select
      ...
      <div
        className={`relative overflow-x-auto ${
          dark ? "shadow-md" : "shadow-xl"
        } sm:rounded-lg my-2 border-2 dark:border-gray-600`}
      >
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 ">
          <thead class="text-xs text-gray-700 uppercase bg-grayark-50 dark:bg-gray-700 dark:text-gray-400 ">
            <tr>
